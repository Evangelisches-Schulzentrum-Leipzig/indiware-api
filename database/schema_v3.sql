-- MariaDB 12+
CREATE DATABASE IF NOT EXISTS timetable_v3
...
CREATE TABLE IF NOT EXISTS building_levels (
    ...
    CONSTRAINT fk_building_level_building FOREIGN KEY (building_id) 
...
CREATE TABLE IF NOT EXISTS rooms (
    ...
    CONSTRAINT fk_room_building_level FOREIGN KEY (building_level) 
        REFERENCES building_levels(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS weeks (
    ...
    CONSTRAINT fk_week_week_type FOREIGN KEY (week_type_id) 
        REFERENCES week_types(id) ON DELETE RESTRICT
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS query_metadata (
    ...
    CONSTRAINT fk_metadata_plan_type FOREIGN KEY (plan_type)
        REFERENCES plan_type(id) ON DELETE RESTRICT
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS teacher_subject_room (
    ...
    CONSTRAINT fk_tsr_ts FOREIGN KEY (teacher_subject_id) 
        REFERENCES teacher_subject(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS lessons (
    ...
    CONSTRAINT fk_lesson_week_type FOREIGN KEY (week_type_id) 
        REFERENCES week_types(id) ON DELETE RESTRICT,
    CONSTRAINT fk_lesson_tsr FOREIGN KEY (teacher_subject_room_id) 
        REFERENCES teacher_subject_room(id)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS lesson_class_period (
    ...
    CONSTRAINT fk_cl_lesson FOREIGN KEY (lesson_id) 
        REFERENCES lessons(id),
    CONSTRAINT fk_cl_period FOREIGN KEY (period_id) 
...
CREATE TABLE IF NOT EXISTS changes (
    ...
    CONSTRAINT fk_change_lesson_class_period FOREIGN KEY (lesson_class_period_id) 
        REFERENCES lesson_class_period(id) ON DELETE CASCADE,
    CONSTRAINT fk_change_state FOREIGN KEY (state) 
        REFERENCES change_states(id) ON DELETE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS teacher_changes (
    ...
    teacher_id SMALLINT UNSIGNED NOT NULL,
    CONSTRAINT fk_teacher_change FOREIGN KEY (change_id) 
        REFERENCES changes(id) ON DELETE CASCADE,
    CONSTRAINT fk_teacher_change_teacher FOREIGN KEY (teacher_id) 
        REFERENCES teachers(id) ON DELETE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS room_changes (
    ...
    change_id MEDIUMINT UNSIGNED NOT NULL,
    room_id SMALLINT UNSIGNED NOT NULL,
    CONSTRAINT fk_room_change FOREIGN KEY (change_id) 
        REFERENCES changes(id) ON DELETE CASCADE,
    CONSTRAINT fk_room_change_room FOREIGN KEY (room_id) 
        REFERENCES rooms(id) ON DELETE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS subject_changes (
    ...
    change_id MEDIUMINT UNSIGNED NOT NULL,
    subject_id SMALLINT UNSIGNED NOT NULL,
    CONSTRAINT fk_subject_change FOREIGN KEY (change_id) 
        REFERENCES changes(id) ON DELETE CASCADE,
    CONSTRAINT fk_subject_change_subject FOREIGN KEY (subject_id) 
        REFERENCES subjects(id) ON DELETE CASCADE
) ENGINE=InnoDB;